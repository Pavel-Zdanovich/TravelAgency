...
public class ReviewControllerTest extends AbstractControllerTest {
    ...
    public void save() throws Exception {
        ...
        MvcResult mvcResult = request(HttpMethod.POST, path, review, HttpStatus.CREATED);
    ...
    public void findAll() throws Exception {
        ...
        List<Review> reviews = objectMapper.readValue(mvcResult.getResponse().getContentAsString(), List.class);
    ...
    public void findByReviewDate() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.
                perform(MockMvcRequestBuilders.get(path).queryParam("date", reviewDate.toString())).
                andExpect(MockMvcResultMatchers.status().isOk()).
                andReturn();
    ...
    public void findByReviewText() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.
                perform(MockMvcRequestBuilders.get(path).queryParam("text", reviewText)).
                andExpect(MockMvcResultMatchers.status().isOk()).
                andReturn();
    ...
    public void delete() throws Exception {
        ...
        mvcResult = request(HttpMethod.DELETE, path, savedReview, HttpStatus.OK);
