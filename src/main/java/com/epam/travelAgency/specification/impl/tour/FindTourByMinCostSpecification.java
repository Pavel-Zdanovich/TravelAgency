...
@Component
public class FindTourByMinCostSpecification implements FindSpecification<Tour, BigDecimal> {
    ...
    public FindTourByMinCostSpecification(BigDecimal minCost) {
        this.minCost = minCost;
    }

    @Override
    public void setSpecification(BigDecimal minCost) {
        this.minCost = minCost;
    }
    ...
    public String getSQLQuery() {
        return String.format(SELECT_TOUR_BY_MIN_COST, this.minCost);
    }
    ...
    public CriteriaQuery<Tour> getCriteriaQuery(CriteriaBuilder criteriaBuilder) {
        ...
        return criteriaQuery.select(root).where(criteriaBuilder.greaterThanOrEqualTo(root.get(Tour_.COST), this.minCost));
    }
