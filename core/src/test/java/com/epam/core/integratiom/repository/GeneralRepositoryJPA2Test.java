...
public class GeneralRepositoryJPA2Test {
    ...
    public void update_Country() {
        GeneralCriterion<Country> countryGeneralCriterion = new GeneralCriterion<>(Country_.COUNTRY_ID, RelationType.EQUAL, 11);
        Iterable<Country> countryIterable = generalRepositoryJPA2.findBy(Country.class, countryGeneralCriterion);
        Iterator<Country> countryIterator = countryIterable.iterator();
    ...
    public void update_Hotel() {
        GeneralCriterion<Hotel> hotelGeneralCriterion = new GeneralCriterion<>(Hotel_.HOTEL_ID, RelationType.EQUAL, 2);
        Iterable<Hotel> hotelIterable = generalRepositoryJPA2.findBy(Hotel.class, hotelGeneralCriterion);
        Iterator<Hotel> hotelIterator = hotelIterable.iterator();
        ...
        Hotel hotel = new Hotel();
        hotel.setHotelId(2);
        hotel.setName("United Arab Emirates Palace");
        hotel.setWebsite("http://www.uae-palace.com");
        hotel.setStars(5);
        hotel.setCoordinate("SRID=4326;POINT(18.576847 61.056834 83.487543)".getBytes(Charset.defaultCharset()));
        hotel.setFeatures(new Feature[]{AIR_CONDITIONER, WI_FI, MINI_BAR, ROOM_SERVICE, RESTAURANT, PARKING, SPA});
        ...
        Assert.assertEquals(previous.getStars(), current.getStars());
    }

    @Test
    public void update_Review() {
        GeneralCriterion<Review> reviewGeneralCriterion = new GeneralCriterion<>(Review_.REVIEW_ID, RelationType.EQUAL, 2);
        Iterable<Review> reviewIterable = generalRepositoryJPA2.findBy(Review.class, reviewGeneralCriterion);
        Iterator<Review> reviewIterator = reviewIterable.iterator();
        ...
        review.setText("very interesting");
        review.setDate(Timestamp.valueOf("2019-09-11 00:00:00"));
    ...
    public void delete_Review() {
        GeneralCriterion<Review> reviewGeneralCriterion = new GeneralCriterion<>(Review_.REVIEW_ID, RelationType.EQUAL, 4);
        Iterable<Review> reviewIterable = generalRepositoryJPA2.findBy(Review.class, reviewGeneralCriterion);
        Iterator<Review> reviewIterator = reviewIterable.iterator();
