...
public class MigrationCondition implements Condition {
    ...
    public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
        try {
            Properties properties = CoreModuleConfiguration.getPropertiesOutOf((ConfigurableEnvironment) context.getEnvironment(), CoreModuleConfiguration.PROPERTY_SOURCE_NAME);
